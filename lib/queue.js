...
Queue.prototype.enqueue = function(name, params, options, callback) {
    ...
    if(options.retries){
        jobInfo.retries = parseInt(options.retries, 10);

        if(options.retryDelayMS){
            jobInfo.retryDelayMS = typeof options.retryDelayMS === 'function' ? options.retryDelayMS.toString() : parseInt(options.retryDelayMS || 0, 10);
        }
    }
