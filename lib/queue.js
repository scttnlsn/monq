...
Queue.prototype.enqueue = function(name, params, options, callback) {
    ...
    if(attempts){
        ...
        if(attempts.delayFunction != null && attempts.delayStrategy != null){
            throw new Error('Only one of delayFunction and delayStrategy may be specified');
        }
        ...
        if(attempts.delayFunction != null){
            jobInfo.attempts.delayFunction = attempts.delayFunction.toString();
        }
